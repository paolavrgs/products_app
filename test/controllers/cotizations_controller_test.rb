...
class CotizationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cotization" do
    assert_difference('Cotization.count') do
      post cotizations_url, params: { cotization: { product_id: @cotization.product_id, quantity: @cotization.quantity, user_id: @cotization.user_id } }
    end
  ...
  test "should update cotization" do
    patch cotization_url(@cotization), params: { cotization: { product_id: @cotization.product_id, quantity: @cotization.quantity, user_id: @cotization.user_id } }
